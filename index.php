...
<div class="promotions">
    <div id="carouselExampleCaptions" class="carousel slide">
        ...
        <div class="carousel-inner">
            ...
            <img src="https://hhstsyoejx.gjirafa.net/gj50/banners/mb-d-1677060548.jpg" class="d-block w-100" alt="...">
...
<div class="latest-products bg-light py-5">
    <div class="container">
            ...
            <div class="col-lg-3 col-md-3 col-sm-12 mt-4">
                <div class="card" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            <strike>1299.99 &euro;</strike>
                            <span class="badge bg-danger">20%</span>
                            <span>1039.99 &euro;</span>
                        </p>
                        <a href="#" class="btn btn-outline-secondary">View product</a>
                    </div>
                </div> <!-- ./card -->
            ...
            <div class="col-lg-3 col-md-3 col-sm-12 mt-4">
                <div class="card" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            <strike>749.99 &euro;</strike>
                            <span class="badge bg-danger">25%</span>
                            <span>562.49 &euro;</span>
                        </p>
                        <a href="#" class="btn btn-outline-secondary">View product</a>
                    </div>
                </div> <!-- ./card -->
        ...
        <div class="text-center mt-5">
            <a href="#" class="btn btn-sm btn-outline-primary">Shop page &rarr;</a>
        </div>
    </div>
</div>
